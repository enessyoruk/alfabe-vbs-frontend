  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 bg-gradient-to-br from-card to-background overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-4 h-4 bg-primary/10 rounded-full animate-pulse" aria-hidden="true" />
        <div
        ...
        <div className="container mx-auto px-4">
          <div className="relative overflow-hidden">
            <div className="flex gap-6 animate-scroll-x hover:pause-animation">
              {/* Image 1 - Modern Classroom */}
              <div className="relative min-w-[400px] h-[300px] rounded-xl overflow-hidden group">
                <img
                  src="/modern-classroom-with-students-studying-mathematic.jpg"
                  alt="Modern Sınıf Ortamı"
                  className="w-full h-full object-cover transition-transform group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-xl font-bold mb-2 text-white drop-shadow-lg">Modern Sınıf Ortamı</h4>
                  <p className="text-sm opacity-90 text-white drop-shadow-md">
                    Teknoloji destekli eğitim sınıflarımızda öğrencilerimiz en iyi koşullarda öğreniyor.
                  </p>
                </div>
              </div>

              {/* Image 2 - Student Success */}
              <div className="relative min-w-[400px] h-[300px] rounded-xl overflow-hidden group">
                <img
                  src="/happy-students-celebrating-academic-success--gradu.jpg"
                  alt="Öğrenci Başarısı"
                  className="w-full h-full object-cover transition-transform group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-xl font-bold mb-2 text-white drop-shadow-lg">Başarı Hikayeleri</h4>
                  <p className="text-sm opacity-90 text-white drop-shadow-md">
                    Öğrencilerimizin akademik başarıları ve kişisel gelişimleri bizim en büyük gururumuz.
                  </p>
                </div>
              </div>

              {/* Image 3 - Teacher Student Interaction */}
              <div className="relative min-w-[400px] h-[300px] rounded-xl overflow-hidden group">
                <img
                  src="/teacher-helping-student-with-homework--one-on-one-.jpg"
                  alt="Öğretmen Öğrenci İletişimi"
                  className="w-full h-full object-cover transition-transform group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-xl font-bold mb-2 text-white drop-shadow-lg">Birebir İlgi</h4>
                  <p className="text-sm opacity-90 text-white drop-shadow-md">
                    Deneyimli öğretmenlerimiz her öğrenciye özel ilgi göstererek potansiyellerini ortaya çıkarıyor.
                  </p>
                </div>
              </div>

              {/* Image 4 - Digital Learning */}
              <div className="relative min-w-[400px] h-[300px] rounded-xl overflow-hidden group">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-xl font-bold mb-2 text-white drop-shadow-lg">Dijital Eğitim</h4>
                  <p className="text-sm opacity-90 text-white drop-shadow-md">
                    Çağdaş eğitim teknolojileri ile öğrencilerimiz geleceğe hazırlanıyor.
                  </p>
                </div>
              </div>

              {/* Image 5 - Parent Communication */}
              <div className="relative min-w-[400px] h-[300px] rounded-xl overflow-hidden group">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-xl font-bold mb-2 text-white drop-shadow-lg">Veli İşbirliği</h4>
                  <p className="text-sm opacity-90 text-white drop-shadow-md">
                    Velilerimizle sürekli iletişim halinde, çocuklarının gelişimini birlikte takip ediyoruz.
                  </p>
                </div>
              </div>
